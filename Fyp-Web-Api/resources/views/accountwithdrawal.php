			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
					<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
						<img src="asset/img/avatar5.png" class='img-circle elevation-2' width="40" height="40" alt="User Image">
					</a>
			...
			<div class="sidebar">
				<nav class="mt-2">
					...
					<li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="/accountdeposit" class="nav-link">
                                <i class="nav-icon fas fa-wallet"></i>
                                <p>Account Deposit</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/accountwithdrawal" class="nav-link">
			...
			<div class="content-wrapper">
						...
						<div class="row mb-2">
							...
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									...
									<li class="breadcrumb-item active">Account Withdrawal</li>
								</ol>
							</div>
						</div>
					</div>
				...
				<section class="content">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-12">
								<button class="btn btn-primary">Add New Withdrawal</button>
								<button class="btn btn-secondary">Export Withdrawal List</button>
							</div>
						</div>
						<div class="row mb-2">
							<div class="col-6">
